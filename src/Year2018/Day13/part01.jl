...
"""
function tick((; id, heading, location, turn)::Cart, rail::StraightRail{VerticalOrientation})
...
function tick((; id, heading, location, turn)::Cart, rail::StraightRail{HorizontalOrientation})
